...
<div className="wrapper">
  ...
  <div className="dentist-heading">
    <h1 className='text-5xl font-bold mb-8'>Our Dentists</h1>
  ...
  <div className="dentist-container">
    ...
    <div className="text">
      <h2 className="dentist-name-heading"> Dr. Rose Gulnaz Cemiloglu </h2> 
      <h3 className="Dentist-subheading">Principal Dentist,  Female, Bachelor of Dental Surgery (BDS)</h3>
      <h3 className="Dentist-subheading">Speaks English, and Turkish</h3>
  ...
  <div className="dentist-imgbox">
    ...
    <div className="text">
      <h2 className="dentist-name-heading"> Dr. Fabiola Menegat </h2> 
      <h3 className="Dentist-subheading">Dentist, Female, Bachelor of Dental Surgery (BDS)</h3>  
      <h3 className="Dentist-subheading">Speaks English, and Portuguese</h3>
  ...
  <div className="dentist-container">
    ...
    <div className="text">
      <h2 className="dentist-name-heading">Dr. Aliakbar Safidroodi</h2> 
      <h3 className="Dentist-subheading">Dentist, Male, Bachelor of Dental Surgery (BDS)</h3>  
      <h3 className="Dentist-subheading">Speaks English</h3>
